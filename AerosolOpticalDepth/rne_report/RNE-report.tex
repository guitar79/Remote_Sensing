...
최근 우리나라에서 대기 중의 미세먼지의 농도가 높아져 ‘나쁨’ 수준으로 높아지는 경우가 자주 나타남에 따라 호흡기 질환자, 노약자에게 큰 위험으로 다가오고 있으며, 여러 산업 분야에도 치명적인 피해를 주고 있다. 대기 중의 에어로졸은 기류를 타고 계속 이동, 확산되는 특징이 있어 단시간에 광범위한 영역을 관측하거나, 주기적으로 지속적인 관측을 하기 위해서는 인공위성 자료를 활용할 필요가 있다. TERRA, AQUA 위성에 탑재되어 있는 MODIS (Moderate Resolution Imaging Spectroradiometer) 센서를 이용하면 대기 중의 에어로졸을 관측할 수 있음이 알려져 있고, 서울지역에서 PM2.5와 PM10 농도를 추정하는 알고리즘이 연구되어 있다 \cite{aleeleekim200601:leeleekim200601, achujung201601:chujung201601}
...
\begin{thebibliography}{99}
	...
	\bibitem[{이동하와 이권호와 김영준; 2006}]{aleeleekim200601:leeleekim200601} 이동하, 이권호, 김영준. (2006). ``동북아 지역 주요 에어로졸 타입 분류를 위한 MODIS 위성 자료의 응용 연구'', 대한환경공학회 학술발표논문집, 687-691.3
	\bibitem[{추교황과 정명재; 2016}]{achujung201601:chujung201601} 추교황, 정명재. (2016). ``MODIS센서를 활용한 서울지역에서의 미세먼지(PM2.5와 PM10)농도 추정 알고리즘 연구''. 한국기상학회 학술대회 논문집, 259-260.
	\bibitem[{이동하와 이권호와 김영준; 2006}]{bleeleekim200601:leeleekim200601} 이동하, 이권호, 김영준. (2006). ``동북아 지역 주요 에어로졸 타입 분류를 위한 MODIS 위성 자료의 응용 연구'', 대한환경공학회 학술발표논문집, 687-691.3
